import { findAllAuthors } from '../services/author.service';

import {saveAuthor, findAuthorById, assignBookToAuthor, deleteAuthor } from '../services/author.service';
import {findBookById, deleteAuthorFromBook } from'../services/book.service.js';
...
export const createAuthorController = async (req, res, next) => {
       try {
           ...
           const existAuthor= await findAuthorByNameAndLastNam
    e(author.name, author.lastName);
